...
def mnemonic_to_entropy_bits(words):
    bitstring = ''.join([format(BIP39_WORDLIST.index(word), '011b') for word in words])
    entropy_length = {12: 128, 15: 160, 18: 192, 21: 224, 24: 256}[len(words)]
    return bitstring[:entropy_length]
